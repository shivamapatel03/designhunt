...
import { Shield, ArrowRight, Loader2, Mail, Key } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#050505] flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-12">
            ...
            <h1 className="text-3xl font-black tracking-tighter uppercase text-white mb-2">Restricted Access</h1>
            <p className="text-gray-500 font-mono text-xs tracking-[0.2em] uppercase">Super Admin Portal</p>
        </div>
                    ...
                    >
                         <div className="relative flex items-center">
                            ...
                            <input 
                                ...
                                required
                                className="w-full pl-16 pr-32 py-6 bg-transparent text-white font-bold text-lg focus:outline-none placeholder:text-gray-800"
