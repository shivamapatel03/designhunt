...
export default function CritiquePage() {
  ...
  const startAnalysis = async () => {
    ...
    setScanProgress(0);
    setFeedback(null);
    setLiveScore(50); // Starting mid-point

    // Simulated scanning sequence with live score fluctuation
    const duration = 4000;
    const interval = 50;
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className="relative w-full aspect-video rounded-[32px] overflow-hidden border-4 border-black mb-12 bg-gray-50">
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center">
                            ...
                            >
                                <div className="text-8xl font-black italic tracking-tighter text-black opacity-10 blur-sm absolute inset-0 text-center">{liveScore}</div>
                                <div className="text-7xl font-black italic tracking-tighter relative z-10 text-black">{liveScore}</div>
                                <div className="text-xs font-black uppercase tracking-widest text-gray-400 text-center -mt-2">Live AI Score</div>
                            </motion.div>
