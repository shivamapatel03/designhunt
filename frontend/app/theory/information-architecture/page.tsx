         ...
         <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-12 items-start">
            <div className="space-y-16">
                 <section>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="p-6 bg-white border border-gray-200 shadow-sm">
                            <div className="w-10 h-10 bg-blue-50 text-blue-600 flex items-center justify-center mb-4">
                        ...
                        <div className="p-6 bg-white border border-gray-200 shadow-sm">
                            <div className="w-10 h-10 bg-purple-50 text-purple-600 flex items-center justify-center mb-4">
                        ...
                        <div className="p-6 bg-white border border-gray-200 shadow-sm">
                            <div className="w-10 h-10 bg-green-50 text-green-600 flex items-center justify-center mb-4">
                         ...
                         <div className="p-6 bg-white border border-gray-200 shadow-sm">
                            <div className="w-10 h-10 bg-orange-50 text-orange-600 flex items-center justify-center mb-4">
             ...
             <aside className="space-y-6 lg:sticky lg:top-24">
                ...
                <div className="p-6 border-2 border-black bg-[#2B7FFF] text-white shadow-[4px_4px_0px_0px_#000]">
