        ...
        >
          ...
          <div className="flex gap-2.5 items-start py-1">
             ...
             <label htmlFor="rules" className="text-[10px] font-bold text-gray-500 leading-tight cursor-pointer select-none font-plus-jakarta">
                I agree to the <a href="#" className="text-black underline underline-offset-4 decoration-1">Rules of Conduct</a> and <a href="#" className="text-black underline underline-offset-4 decoration-1">Privacy</a> Policies.
             </label>
          </div>
