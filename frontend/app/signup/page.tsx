    ...
    <div className="min-h-screen bg-[#fafafa] flex flex-col font-sans selection:bg-black selection:text-white overflow-hidden pt-8 md:pt-20">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4 max-w-[340px] mx-auto w-full relative z-10">
        ...
        >
             ...
             <h1 className="text-xl font-black tracking-tight text-black font-plus-jakarta">Create Account</h1>
        </motion.div>
        ...
        >
          {error && (
            <div className="p-3 bg-red-50 text-red-500 rounded-xl text-[10px] font-black text-center border border-red-100 font-plus-jakarta">
               {error}
            </div>
          )}
          ...
          <div className="flex gap-2.5 items-start py-1">
             <input 
                ...
                required 
             />
             <label htmlFor="rules" className="text-[10px] font-bold text-gray-500 leading-tight cursor-pointer select-none font-plus-jakarta">
                I agree to the <Link href="/rules" className="text-black underline underline-offset-4 decoration-1">Rules of Conduct</Link> and <Link href="/privacy" className="text-black underline underline-offset-4 decoration-1">Privacy</Link> Policies.
             </label>
          </div>
        ...
        <button 
          ...
          className="w-full flex items-center justify-center py-3.5 bg-white border border-gray-100 rounded-[18px] transition-all shadow-[0_4px_0_0_#efefef] active:shadow-none active:translate-y-[4px] hover:bg-gray-50 group"
        >
