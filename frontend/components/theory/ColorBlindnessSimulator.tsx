...
export function ColorBlindnessSimulator() {
  ...
  return (
    <div className="bg-white border-2 border-black p-6 shadow-[4px_4px_0px_0px_#000]">
      ...
      <div className="mb-4 bg-blue-50 text-blue-800 p-4 text-sm">
        <strong>Effect:</strong> {filters.find(f => f.id === activeFilter)?.desc}
      </div>

      {/* Simulation Area */}
      <div className="relative overflow-hidden border-2 border-gray-200 h-80">
        ...
        >
            ...
            <div className="w-full max-w-md space-y-4">
                ...
                <button className="px-6 py-3 bg-purple-600 text-white font-bold">Primary Action</button>
            </div>
