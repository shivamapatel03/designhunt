...
export function SkillActivityCard({ title, percentage, status, themeColor = "#FFF8D6" }: SkillActivityCardProps) {
  ...
  return (
    <div 
      ...
      className="relative p-6 rounded-[32px] border border-black/5 flex flex-col justify-between h-[160px] cursor-pointer transition-transform active:scale-[0.98]"
