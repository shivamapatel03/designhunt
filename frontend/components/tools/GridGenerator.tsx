...
export function GridGenerator() {
  ...
  return (
    <div className="bg-white border-2 border-black  p-6 md:p-8 shadow-[8px_8px_0px_0px_#000]">
           ...
           <div className="flex flex-wrap gap-2">
               {presets.map(p => (
                   <button
                        ...
                        className="px-3 py-1.5 text-xs font-bold border-2 border-gray-200  hover:border-black hover:bg-gray-50 transition-all"
                   >
                       {p.name}
                   </button>
               ))}
       ...
       <div className="grid lg:grid-cols-[300px_1fr] gap-8 mb-8">
          {/* Controls */}
          <div className="space-y-6 bg-gray-50 p-6  border-2 border-gray-100">
              <div>
          ...
          {/* Visual Preview */}
          <div className="relative bg-white border-2 border-dashed border-gray-300  overflow-hidden min-h-[300px] flex items-center justify-center p-4">
               {/* The actual grid */}
               <div 
        ...
        {/* Code Output */}
        <div className="flex items-center justify-between bg-[#1e1e1e] text-gray-300 p-1  pl-4">
            <code className="font-mono text-xs md:text-sm truncate">
                {`grid-cols-${columns} gap-[${gap}px]`}
            </code>
            <button 
                onClick={copyToClipboard}
                className="flex items-center gap-2 bg-white text-black px-4 py-2  font-bold text-xs hover:bg-gray-100 transition-colors"
            >
