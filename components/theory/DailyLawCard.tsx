...
export function DailyLawCard() {
  ...
  return (
    <motion.div 
      ...
      className="relative overflow-hidden rounded-3xl border-2 border-black bg-white p-8 md:p-10 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] mb-16"
    >
